...
import { openmrsObservableFetch, useCurrentPatient, newWorkspaceItem } from '@openmrs/esm-api';
import { of } from 'rxjs';
...
describe('Visit Button Component', () => {
  ...
  function setUpMockPatientVisitResponse(mockData: any) {
    mockOpenmrsObservableFetch.mockImplementationOnce((url: string, config: { method: string; body: any }) => {
