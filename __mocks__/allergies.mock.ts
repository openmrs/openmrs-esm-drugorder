  ...
  setMembers: [
    {
      ...
      conceptClass: {
        ...
        links: [
          {
            rel: 'self',
            uri: 'http://localhost:8090/openmrs/ws/rest/v1/conceptclass/8d4918b0-c2cc-11de-8d13-0010c6dffd0f',
          },
        ],
      },
      set: false,
      ...
      links: [
        {
          rel: 'self',
          uri: 'http://localhost:8090/openmrs/ws/rest/v1/concept/121677AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
        },
        {
          rel: 'full',
          uri: 'http://localhost:8090/openmrs/ws/rest/v1/concept/121677AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA?v=full',
        },
      ],
      resourceVersion: '2.0',
    },
    {
      ...
      descriptions: [
        {
          ...
          display: 'A reduction in the number of circulating erythrocytes or in the quantity of hemoglobin.',
          links: [
            {
              rel: 'self',
              uri:
      ...
      links: [
        {
          rel: 'self',
          uri: 'http://localhost:8090/openmrs/ws/rest/v1/concept/121629AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
        },
        {
          rel: 'full',
          uri: 'http://localhost:8090/openmrs/ws/rest/v1/concept/121629AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA?v=full',
        },
      ],
      resourceVersion: '2.0',
    },
    {
      ...
      links: [
        {
          rel: 'self',
          uri: 'http://localhost:8090/openmrs/ws/rest/v1/concept/148888AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
        },
        {
          rel: 'full',
          uri: 'http://localhost:8090/openmrs/ws/rest/v1/concept/148888AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA?v=full',
        },
      ],
      resourceVersion: '2.0',
    },
...
export const mockPatientAllergyResultWithoutOnsetDate = {
  data: {
    ...
    entry: [
      {
        fullUrl: `http://localhost:8080/openmrsws/rest/v1/concept/AllergyIntolerance/0ff69971-f82a-4e3d-b59f-9e515cae7a6a`,
        resource: {
          resourceType: 'AllergyIntolerance',
          ...
          code: {
            coding: [
              ...
              {
                system: 'http://www.nlm.nih.gov/research/umls/sourcereleasedocs/current/NDFRT/',
                code: 'N0000000181',
              },
              {
                system: 'http://www.nlm.nih.gov/research/umls/sourcereleasedocs/current/NDFRT/',
          ...
          note: [
            {
              text: 'The patient is having a difficulty while using this medication',
            },
          ],
          reaction: [
            {
              manifestation: [
                {
                  coding: [
                    ...
                    {
                      system: 'http://www.who.int/classifications/icd/adaptations/icpc2/en/',
                      code: 'A92',
                    },
                    {
                      system: 'http://openmrs.org',
      ...
      },
      {
        ...
        resource: {
          ...
          note: [
            {
              text: 'The patient had to be rushed to the emergency room after suffering from this reaction',
            },
          ],
          reaction: [
            {
...
export const mockSaveAllergyResponse = {
  ...
  allergen: {
    ...
    codedAllergen: {
      ...
      links: [
        {
          rel: 'self',
          uri: 'http://localhost:8090/openmrs/ws/rest/v1/concept/162536AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
        },
      ],
    },
    nonCodedAllergen: null,
  ...
  severity: {
    ...
    links: [
      {
        rel: 'self',
        uri: 'http://localhost:8090/openmrs/ws/rest/v1/concept/1498AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
      },
    ],
  },
  comment: 'Patient was tilling farmland when he was ambushed by a swarm of bees and stung several times.',
  reactions: [
    {
      reaction: {
        ...
        links: [
          {
            rel: 'self',
            uri: 'http://localhost:8090/openmrs/ws/rest/v1/concept/512AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
          },
        ],
      },
    ...
    },
    {
      reaction: {
        ...
        links: [
          {
            rel: 'self',
            uri: 'http://localhost:8090/openmrs/ws/rest/v1/concept/111061AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
          },
        ],
      },
      reactionNonCoded: null,
