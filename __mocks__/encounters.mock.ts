export const mockPatientEncounters = {
  data: {
    ...
    link: [
      {
        relation: 'self',
        url: 'http://localhost:8080/openmrs/ws/fhir2/Encounter?_id=638591-9586-4b2b-a511-17bc1b79d1ba',
      },
    ],
    entry: [
      {
        fullUrl: 'http://localhost:8080/openmrs/ws/fhir2/Encounter/638591-9586-4b2b-a511-17bc1b79d1ba',
        resource: {
      ...
      {
        fullUrl: 'http://localhost:8080/openmrs/ws/fhir2/Encounter/11238591-9586-4b2b-a511-17bc1b79d1ba',
        resource: {
          resourceType: 'Encounter',
      ...
      {
        fullUrl: 'http://localhost:8080/openmrs/ws/fhir2/Encounter/24638591-9586-4b2b-a511-17bc1b79d1ba',
        resource: {
          resourceType: 'Encounter',
      ...
      auditInfo: {
        creator: {
          ...
          links: [
            {
              rel: 'self',
              uri: 'http://localhost:8090/openmrs/ws/rest/v1/user/bff0f63d-d192-46c7-9bbd-932affa29b80',
            },
          ],
        },
      ...
      auditInfo: {
        creator: {
          ...
          links: [
            {
              rel: 'self',
              uri: 'http://localhost:8090/openmrs/ws/rest/v1/user/55c32ecf-a66e-44ad-98db-6390371fc202',
            },
          ],
        },
  ...
  obs: [
    {
      ...
      display: 'Visit Diagnoses: Presumed diagnosis, Primary, Vitamin A Deficiency with Keratomalacia',
    },
    {
      uuid: '78765452-58a8-4f0a-91ff-831647a2e9dc',
      display: 'Visit Diagnoses: Other disease of hard tissue of teeth, Secondary, Confirmed diagnosis',
    },
    {
      uuid: '06c212a3-61f5-401d-8afd-2917c662c0ea',
      display: 'Text of encounter note: Duis aute irure dolor in reprehenderit in voluptat',
    },
  ],
  orders: [],
  voided: false,
