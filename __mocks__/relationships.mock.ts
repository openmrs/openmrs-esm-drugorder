export const mockRelationships = {
  data: {
    ...
    entry: [
      {
        fullUrl: 'http://localhost:8080/openmrs/ws/fhir2/RelatedPerson/f9845d52-35ad-4031-81d5-b62a1a9c4984',
        resource: {
      ...
      {
        fullUrl: 'http://localhost:8080/openmrs/ws/fhir2/RelatedPerson/0151ecec-4d32-451b-b7ad-6bb50e6433dd',
        resource: {
          resourceType: 'RelatedPerson',
